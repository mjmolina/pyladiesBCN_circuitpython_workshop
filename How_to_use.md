...
- Install the Device Simulator Express (Extension from the marketplace), once it is installed, you will need to reload VScode. 

In some cases it is needed close the Visual studio code and open it again (sometimes a couple of times).
______
...
In this case, it was running `python 3.9.1`, but run `python 3.7+` will work good. 
